...
const charCount = document.querySelector('li[data-testid="char-count"]');
const noSpaces = document.querySelector('li[data-testid="char-no-spaces-count"]');
const wordLenght = document.querySelector('li[data-testid="agv-word-length"]');
const numCount = document.querySelector('li[data-testid="num-count"]');
const sumCount = document.querySelector('li[data-testid="num-sum"]');
